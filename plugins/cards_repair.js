...
const toHTML = cardRepair => `
<a class="card" href="./pages/project_gallery.html">
    <div class="img_card">
        <img src="${cardRepair.img}" alt="">
    </div>
    <p class="top_text_card">${cardRepair.title}</p>
    <p class="bot_text_card">${cardRepair.text}</p>
</a>
`

function cardRepair () {
    const html = arrCardsRepair.map(toHTML).join('');
